  ...
  return (
    <div className="flex h-screen bg-base">
      ...
      <div className="flex flex-col w-full px-15">
        <Header />
        <main className="container flex flex-col h-[90vh] my-5  px-2 overflow-hidden">
          <MainBody /> 
        </main>
      </div>
    </div>
...
const MainBody = () => {
  return (
    <>
      ...
      />
      <div className="w-full border rounded-full h-[10%] flex flex-row-reverse items-center p-5 gap-10">
